...
export const CalendarModal = () => {
    ...
    return (
        <Modal className="modal" isOpen={isDateModalOpen} style={customStyles} onRequestClose={onCloseModal} overlayClassName="modal-background" closeTimeoutMS={200}>
            <h1>Nuevo Evento</h1>
            <hr />
            ...
            <form className="container" onSubmit={onSubmit}>
                ...
                <div className="form-group mb-2">
                    ...
                    <input type="text" className={`form-control ${titleClass}`} placeholder="Title and notes" name="title"
