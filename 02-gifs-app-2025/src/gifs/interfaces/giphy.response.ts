export interface GiphyResponses {
    data: GiphyGif[];
    meta: Meta;
...
export class Convert {
    public static toGiphyResponses(json: string): GiphyResponses {
        return cast(JSON.parse(json), r("GiphyResponses"));
    }

    public static giphyResponsesToJson(value: GiphyResponses): string {
        return JSON.stringify(uncast(value, r("GiphyResponses")), null, 2);
    }
}
