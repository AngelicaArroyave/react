...
describe('Test in FavoriteHeroContext', () => {
    beforeEach(() => {
        localStorage.clear()
    })
    ...
    test('should add hero to favorites when toggleFavorite called with new Hero', () => {
        renderContextTest()
    ...
    test('should remove hero from favorites when toggleFavorite called', () => {
